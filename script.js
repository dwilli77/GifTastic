...
// click even on the -Add!- button to add a category
...
function displayGifs(){
    ...
    let queryURL = "https://api.giphy.com/v1/gifs/search?q=" + category + "&api_key=yOEsL4XsJC1T3awMVcC8cx8B4v5wacvv&limit=10";
    $.ajax({
        url: queryURL,
        method: "GET"
